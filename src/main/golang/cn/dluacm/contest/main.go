...
import (
	"acm-registration-system/config"
	"acm-registration-system/dal"
	"acm-registration-system/router"
...
func gormGen() {
	...
	admin_info := g.GenerateModel("admin_info", fieldOpts...)
	information := g.GenerateModel("information", fieldOpts...)
	log := g.GenerateModel("log", fieldOpts...)

	g.ApplyBasic(admin_info, information, log)
	g.Execute()
}
